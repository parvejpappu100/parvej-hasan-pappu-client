...
const Navbar = () => {
    ...
    const navOption = <>
        ...
        <li><Link style={activeLink === 'testimonial' ? { color: '#FF6B00', backgroundColor: 'white', borderBottom: '4px solid #FF6B00', borderRadius: "0px" } : {}}
            className='hover:text-[#FF6B00]'
            to="testimonial"
            spy={true}
            smooth={true}
        ...
        <li><Link style={activeLink === 'contact' ? { color: '#FF6B00', backgroundColor: 'white', borderBottom: '4px solid #FF6B00', borderRadius: "0px" } : {}}
            className='hover:text-[#FF6B00]'
            to="contact"
            spy={true}
            smooth={true}
